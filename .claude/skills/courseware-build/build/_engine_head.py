...
def cover():
    ...
    if badge:
        ...
        txt(s,Inches(10.75),Inches(0.78),Inches(1.85),Inches(0.52),[[("GenAI",19,WHITE,True)]],align=PP_ALIGN.CENTER)
        txt(s,Inches(10.75),Inches(1.32),Inches(1.85),Inches(0.4),[[("PROBLEM SOLVING",8,WHITE,True)]],align=PP_ALIGN.CENTER)
